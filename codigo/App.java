...
public class App {
    public static void main(String[] args) throws VagaOcupadaException, UsoDeVagaException, VagaDesocupadaException {
        ...
        UsoDeVaga usoDeVaga = new UsoDeVaga(vaga1); // perguntar pro professor pq quando o usoDeVaga é criado ele
                                                    // retorna o total de usos errado
        ...
        System.out.println("Total de usos do veiculo " + veiculo1.getPlaca() + ": " + veiculo1.totalDeUsos());

        System.out.println(veiculo1);
        System.out.println(veiculo2);
        System.out.println("Arrecadado por veículo: " + cliente.arrecadadoPorVeiculo("123"));
        System.out.println("Arrecadado total: " + cliente.arrecadadoTotal());
        // System.out.println(usoDeVaga.ehDoMes(11));
    }
}
...
public class App {
    ...
    public static void main(String[] args) throws UsoDeVagaException, VagaDesocupadaException, VagaOcupadaException,
        ...
        try {
            ...
            System.out.println("Entrada inválida. Certifique-se de inserir uma opção válida!.");
        }
    }
                ...
                switch (escolha) {
                    ...
                    case 2:
                        ...
                        try {
                            if (cliente2 == null) {
                                throw new Exception(
                                        "Cliente não cadastrado. Cadastre o cliente antes de adicionar um veículo.");
                            }
                    ...
                    case 3:
                        System.out.println(
                                "Opção não implementada devido a falta de pessoal. Estamos trabalhando para aprimorar sua experiência :)");
                        break;
                    case 4:
                        ...
                        System.out.println("O valor arrecadado pelo estacionamento no mês" + mes + " foi de "
                                + arrecadacaoNoMes);
                    ...
                    case 5:
                        ...
                        System.out.println("O top5 de clientes do estacionamento no mês" + mes1
                                + " está nesse momento assim" + clientes);
                    ...
                    case 7:
                        ...
                        System.out.println("O valor médio por uso é de:" + media);
            ...
            while (escolha != 4) {
                switch (escolha) {
                    case 1:
                        ...
                        String placa = scanner.nextLine();
                        System.out.println("Gostaria de contratar algum serviço? 1. Sim 2. Não");
                        ...
                        switch (option) {
                            case 1:
                                ...
                                try {
                                    ...
                                    System.out.println(
                                            "Serviço inválido. Escolha entre MANOBRISTA, LAVAGEM ou POLIMENTO.");
                            ...
                            case 2:
                                ...
                                double valorPago = 0;
                                try {
                                    if (!getVeiculos.containsKey(placa1)) {
                                        throw new Exception(
                                                "Veículo não cadastrado. Cadastre o veículo antes de sair.");
                                    }
                    ...
                    case 3:
                        ...
                        try {
                            if (!getVeiculos.containsKey(placa2)) {
                                throw new Exception(
                                        "Veículo não cadastrado. Cadastre o veículo antes de gerar o relatório.");
                            }
